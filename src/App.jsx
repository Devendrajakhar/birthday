      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Kanchan</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Kanchan's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>Dosti woh hai jo smile laa de,
aur bina bole sab samjha de.
Lucky hoon ki tu hai mere saath 🤍
Stay same, bro ✨</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — JAKHAR 💖</h2>
          <p className="final-subtitle">Thanks for being my unpaid therapist and partner in crime 🤝😜</p>
        </section>
      </div>
